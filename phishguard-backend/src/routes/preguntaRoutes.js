...
const { listarPreguntas, obtenerPregunta, crearPregunta, actualizarPregunta, eliminarPregunta, importarPreguntas } = require('../controllers/preguntaController');
const auth = require('../middlewares/auth');
const autorizar = require('../middlewares/roles');

router.get('/:moduloId', auth, autorizar('admin'), listarPreguntas);
router.post('/:moduloId/importar', auth, autorizar('admin'), importarPreguntas);
